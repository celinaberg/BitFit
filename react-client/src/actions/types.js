...
export type UpdateNewLessonAction = { type: 'UPDATE_NEW_LESSON', payload: { title:string, background:RichTextEditor } };
export type SaveNewLessonAction = { type: 'SAVE_NEW_LESSON', payload: { title:string, background:string } };
export type SaveLessonAction = { type: 'SAVE_LESSON', payload: { id: string, title:string, background:string } };
...
export type SaveQuestionFulfilledAction = { type: 'SAVE_QUESTION_FULFILLED', payload:Question };

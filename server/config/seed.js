      ...
      Question.create(
        {
          title: "1 to 10",
          instructions:
            "New, w1q1 from MongoDB!! Add code to the code editor to make the system output numbers 1 through 10.",
        ...
        },
        {
          title: "Looping",
          instructions:
            "New, w1q2 from MongoDB!! Add code to the code editor to create a valid for loop.",
          code:
    ...
    Logger.find({}).remove(function() {
      ...
      Logger.create(
        ...
        function() {
          ...
          resolve("successfully seeded test data");
        }
      );
    });
  });
